...
All elements must have a line of space between them

Please note that nested elements (e.g. an italic word inside a bold sentence) are not currently supported.
